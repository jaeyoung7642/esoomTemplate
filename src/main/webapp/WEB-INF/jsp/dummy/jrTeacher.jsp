...
<head>
	...
	<meta property="og:title" content="강사진 소개 : KCC이지스 프로농구단">
	<meta property="og:image" content="https://kccegis.com/resources/common/images/common/kcc_og_thum.jpg">
	<meta property="og:description" content="부산KCC이지스 공식 홈페이지">
	<title>강사진 소개 : KCC이지스 프로농구단</title>
					...
					<div class="inner">
						<div class="snb_2dth snb_list menu_slider">
							<div class="swiper-wrapper">
								<a href="jrInfo.do" class="swiper-slide snb_link"><span>JR.KCC 소개</span></a>  <!-- 해당페이지에 current 추가 -->
								<a href="jrTeacher.do" class="swiper-slide snb_link current"><span>강사진 소개</span></a> 
							</div> 
						</div>
					</div>
				</div>
				...
				<div class="ly_inner md">
					<ul class="jr_teacher_list">
						<li class="item">
							<div class="photo">
								<div class="el_img">
									<img src="<c:url value='/resources/common/images/img/jr_teacher_01.webp'/>" alt="백승혁 매니저 사진">
								</div>
							</div>
							<div class="info">
						...
						<li class="item">
							<div class="photo">
								<div class="el_img">
									<img src="<c:url value='/resources/common/images/img/jr_teacher_02.webp'/>" alt="김동현 코치 사진">
								</div>
							</div>
							<div class="info">

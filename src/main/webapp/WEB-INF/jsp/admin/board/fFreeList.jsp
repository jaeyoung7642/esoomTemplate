			...
			<main id="contents" class="ly_contents">
				...
				<div class="pagination mt20">
					...
					<c:if test="${startPage gt 1 }">
                       	<a href="fFreeList.do?page=${startPage-1}&searchKeyword=${searchKeyword}&searchTitle=${searchTitle}&searchContent=${searchContent}&searchWriter=${searchWriter}&searchTail=${searchTail}&searchTailWriter=${searchTailWriter}&searchChk_del=${searchChk_del}" class="page_link ico prev"><span class="blind">이전</span></a> <!-- 비활성화시 disabled 추가 -->
                    </c:if>
					...
					<a href="fFreeList.do?page=${endPage+1}&searchKeyword=${searchKeyword}&searchTitle=${searchTitle}&searchContent=${searchContent}&searchWriter=${searchWriter}&searchTail=${searchTail}&searchTailWriter=${searchTailWriter}&searchChk_del=${searchChk_del}" class="page_link ico next"><span class="blind">다음</span></a>
                    </c:if>
				...
				<div class="btn_area mt40">
					<a href="fFreeWrite.do" class="el_btn md line">등록</a>
				</div>
				<!-- 작성자 정보 팝업 -->

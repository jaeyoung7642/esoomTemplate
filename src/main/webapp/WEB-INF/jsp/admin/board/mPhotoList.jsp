		...
		<div id="container" class="ly_container"> 
			...
			<main id="contents" class="ly_contents">
				...
				<div class="board_search">
					<form action="mPhotoList.do" class="search_group">
				...
				<ul class="board_list type1 mt30">
					...
					<li class="item">
						<div class="bbs_box">
							<a href="mPhotoWrite.do?num=${photoList.num }">
								<div class="thumb">
							...
							<p class="info">
								<span class="date">${photoList.formatted_date}</span>
				...
				<div class="pagination mt20">
					...
					<c:if test="${maxPage > 0}">
					<a href="mPhotoList.do?page=1&searchKeyword=${searchKeyword}&sdate=${sdate}&edate=${edate}" class="page_link ico first"><span class="blind">처음</span></a> <!-- 비활성화시 disabled 추가 -->
					</c:if>
					
					<!-- 이전 블럭으로 이동 -->
					<c:if test="${startPage gt 1 }">
                       	<a href="mPhotoList.do?page=${startPage-1}&searchKeyword=${searchKeyword}&sdate=${sdate}&edate=${edate}" class="page_link ico prev"><span class="blind">이전</span></a> <!-- 비활성화시 disabled 추가 -->
                    </c:if>
                    ...
                    <c:forEach var="p" begin="${startPage}" end="${endPage}" step="1">
                      ...
                      <c:if test="${p ne currentPage }">
                      	<c:url var="mPhotoList" value="mPhotoList.do?&searchKeyword=${searchKeyword}&sdate=${sdate}&edate=${edate}">
					...
					<a href="mPhotoList.do?page=${endPage+1}&searchKeyword=${searchKeyword}&sdate=${sdate}&edate=${edate}" class="page_link ico next"><span class="blind">다음</span></a>
                    </c:if>
                    ...
                    <c:if test="${maxPage > 0}">
					<a href="mPhotoList.do?page=${maxPage}&searchKeyword=${searchKeyword}&sdate=${sdate}&edate=${edate}" class="page_link ico last"><span class="blind">마지막</span></a>
					</c:if>
				</div>
				<!-- // pagination -->
				</c:if>
				<div class="btn_area mt40">
					<a href="mPhotoWrite.do" class="el_btn md line">등록</a>
				</div>

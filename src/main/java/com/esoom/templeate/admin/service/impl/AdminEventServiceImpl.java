...
public class AdminEventServiceImpl extends EgovAbstractServiceImpl implements AdminEventService {
	 ...
	 */
	@Override
	public List<?> eventList(PageInfo pi,BoardVO boardVO) throws Exception {
		return adminEventDao.eventList(pi,boardVO);
	}
	...
	public int getTotalEventListCount(BoardVO boardVO) {
		return adminEventDao.getTotalEventListCount(boardVO);
	}
	/**
	 * 글 총 갯수를 조회한다.
	 * @param searchVO - 조회할 정보가 담긴 VO
	...
	public int getEventListCount(BoardVO boardVO) {
		return adminEventDao.getEventListCount(boardVO);
	}
	@Override
	public int mergeBoard(BoardVO boardVO) throws Exception {
		return adminEventDao.mergeBoard(boardVO);
	}
	@Override
	public int deleteBoard(BoardVO boardVO) throws Exception {
		return adminEventDao.deleteBoard(boardVO);
	}
	@Override
	public int getEventTailListCount(BoardVO boardVO) {
		return adminEventDao.getEventTailListCount(boardVO);
	}
	@Override
	public List<?> eventTailList(PageInfo pi, BoardVO boardVO) throws Exception {
		return adminEventDao.eventTailList(pi,boardVO);
	}
}

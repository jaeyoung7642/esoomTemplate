...
public class AdminMovieServiceImpl extends EgovAbstractServiceImpl implements AdminMovieService {
	...
	public List<?> movieList(PageInfo pi,BoardVO boardVO) throws Exception {
		return adminMovieDao.movieList(pi,boardVO);
	}
	...
	public int getTotalMovieListCount(BoardVO boardVO) {
		return adminMovieDao.getTotalMovieListCount(boardVO);
	}
	/**
	 * 글 총 갯수를 조회한다.
	 * @param searchVO - 조회할 정보가 담긴 VO
	...
	public int getMovieListCount(BoardVO boardVO) {
		return adminMovieDao.getMovieListCount(boardVO);
	}
}

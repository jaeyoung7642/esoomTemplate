...
public class NewsServiceImpl extends EgovAbstractServiceImpl implements NewsService {
	 ...
	 */
	@Override
	public List<?> newsHome(BoardVO boardVO) throws Exception {
		return newsDao.newsHome(boardVO);
	}
	@Override
	public List<?> newsList(PageInfo pi,BoardVO boardVO) throws Exception {
		return newsDao.newsList(pi,boardVO);
	}
	@Override
	public int getNewsListCount(BoardVO boardVO) {
		return newsDao.getNewsListCount(boardVO);
	}
